...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background: #eb7ce5;">
        <div class="container">
            <RouterLink :to="{ name: 'home' }" class="navbar-brand">สถานที่ท่องเที่ยวในประเทศไทย</RouterLink>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="bi bi-bank2 me-1"></i>สถานที่ท่องเที่ยวในไทย
                        </a>

                        <ul class="dropdown-menu">
                            <li>
                                <RouterLink :to="{ name: 'wonders' }" class="dropdown-item">สถานที่ท่องเที่ยวในไทย
                                </RouterLink>
                            </li>
                            <li>
                                <RouterLink :to="{ name: 'add-wonder' }" class="dropdown-item">เพิ่มสถานที่ท่องเที่ยวในไทย
                                </RouterLink>
                            </li>
                            <li><a class="dropdown-item" href="#">แก้ไขสถานที่ท่องเที่ยวในไทย</a></li>
                            <li><a class="dropdown-item" href="#">ลบสถานที่ท่องเที่ยวในไทย</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="https://www.wonderspodcast.com/wonders">เว็บไซต์ สถานที่ท่องเที่ยวดังๆในไทย</a></li>
                        </ul>
                    </li>
